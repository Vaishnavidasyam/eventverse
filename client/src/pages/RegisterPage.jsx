...
const RegisterPage = () => {
  ...
  useEffect(() => {
    ...
    if (roleFromUrl) {
      setFormData({ ...formData, role: roleFromUrl });
    }
  }, [searchParams]);
  ...
  return (
    <div className="min-h-screen pt-20 flex items-center justify-center px-4 py-12 bg-bg-main">
      <motion.div
      ...
      >
        <div className="glass-card p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-text-muted mt-2">Join the event revolution</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-text-secondary">Phone (Optional)</label>
              <div className="relative">
            ...
            <div className="glass-card-light p-3">
              <p className="text-sm text-text-muted">Registering as:</p>
